...
/*if($conc)
 ...
 $insert=mysqli_query($conc,"INSERT INTO user_log(Email_id,Name,Contact_No,UPassword) VALUES('$m','$n','$c','$p')");
...
<main class="form-signin w-100 m-auto">
  <form action="login.html" method="post">
    <img class="mb-4" src="css/img/img1.png" alt="" width="82" height="67">
      <p>Click on the button given below to move back to the Login page</p>
    <button class="w-100 btn btn-lg btn-primary" type="submit">Login Page!</button>
